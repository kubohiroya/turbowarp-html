...
function checkPolicy() {
  ...
  if (policy.productName !== 'TurboWarp HTML') {
...
function checkPackageMetadata() {
  ...
  if (packageMetadata.repository?.url !== 'git+https://github.com/kubohiroya/turbowarp-html.git') {
    errors.push('package.json repository.url must point to the current repository');
  }
  if (packageMetadata.bugs?.url !== 'https://github.com/kubohiroya/turbowarp-html/issues') {
...
function checkReadmes() {
  ...
  if (!readmeJa.startsWith('# TurboWarp HTML\n')) {
...
async function checkPackContents() {
  ...
  if (!files.has('dist/turbowarp-html.js')) {
