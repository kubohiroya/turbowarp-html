...
(function (Scratch) {
  ...
  var block_definitions_default = {
  	extensionName: "TurboWarp HTML",
  	blocks: [
  		{
  			"opcode": "text",
  			"blockType": "REPORTER",
  			"text": "text [TEXT]",
  			"description": "Creates an escaped HTML text fragment.",
  			"arguments": { "TEXT": {
  				"type": "STRING",
  		...
  		},
  		{
  			"opcode": "element",
  			"blockType": "REPORTER",
  			"text": "element [TAG] content [CONTENT]",
  			"description": "Creates a valid HTML element with escaped structured content.",
  			"arguments": {
  				"TAG": {
  					"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "[ELEMENT] with attribute [NAME] = [VALUE]",
  			"description": "Returns a new element with a safe escaped attribute value.",
  			"arguments": {
  				"ELEMENT": {
  					"type": "STRING",
  					"defaultValue": ""
  		...
  		},
  		{
  			...
  			"description": "Creates a fragment sequence from two HTML fragments.",
  			"arguments": {
  				"LEFT": {
  					"type": "STRING",
  					"defaultValue": ""
  		...
  		},
  		{
  			"opcode": "render",
  			"blockType": "REPORTER",
  			"text": "render HTML [FRAGMENT]",
  			"description": "Renders an HTML fragment to final HTML text without updating stored validation errors.",
  			"arguments": { "FRAGMENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "render HTML with validation [FRAGMENT]",
  			"description": "Validates an HTML fragment, stores any validation errors, and renders final HTML text.",
  			"arguments": { "FRAGMENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "last HTML validation errors",
  			"description": "Returns validation errors stored by the most recent render HTML block.",
  			"arguments": {}
  		},
  		{
  			"opcode": "lastRenderHasValidationErrors",
  			"blockType": "BOOLEAN",
  			"text": "last rendered HTML has validation errors?",
  			"description": "Reports whether the most recent render HTML block stored validation errors.",
  			"arguments": {}
  		},
  		{
  			"opcode": "validateHtml",
  			"blockType": "REPORTER",
  			"text": "validate HTML [FRAGMENT]",
  			"description": "Returns simple validation diagnostics for an HTML fragment.",
  			"arguments": { "FRAGMENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			"opcode": "isValidHtml",
  			"blockType": "BOOLEAN",
  			"text": "HTML [FRAGMENT] is valid?",
  			"description": "Reports whether simple validation found no HTML errors.",
  			"arguments": { "FRAGMENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"description": "Creates an anchor with a conservatively validated URL.",
  			"arguments": {
  				"CONTENT": {
  					"type": "STRING",
  		...
  		},
  		{
  			"opcode": "externalLink",
  			"blockType": "REPORTER",
  			"text": "external link [CONTENT] URL [URL]",
  			"description": "Creates an anchor that opens in a new tab with safe rel attributes.",
  			"arguments": {
  				"CONTENT": {
  					"type": "STRING",
  					"defaultValue": "TurboWarp"
  		...
  		},
  		{
  			"opcode": "image",
  			"blockType": "REPORTER",
  			"text": "image URL [SRC] alt [ALT]",
  			"description": "Creates a void image element with safe src and escaped alt text.",
  			"arguments": {
  				"SRC": {
  					"type": "STRING",
  					"defaultValue": "/status.png"
  				},
  				"ALT": {
  					"type": "STRING",
  					"defaultValue": "status"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "TurboWarp project [PROJECT_ID] iframe title [TITLE] width [WIDTH] height [HEIGHT]",
  			"description": "Creates a safe iframe for playing a TurboWarp project.",
  			"arguments": {
  				"PROJECT_ID": {
  					"type": "STRING",
  					"defaultValue": "414716080"
  				},
  				"TITLE": {
  					"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "Scratch project [PROJECT_ID] iframe title [TITLE] width [WIDTH] height [HEIGHT]",
  			"description": "Creates a safe iframe for playing a Scratch project.",
  			"arguments": {
  				"PROJECT_ID": {
  					"type": "STRING",
  					"defaultValue": "104"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "packaged TurboWarp project iframe URL [SRC] title [TITLE] width [WIDTH] height [HEIGHT]",
  			"description": "Creates a safe iframe for playing a same-site TurboWarp Packager HTML file.",
  			"arguments": {
  				"SRC": {
  					"type": "STRING",
  					"defaultValue": "./project.html"
  				},
  				"TITLE": {
  					"type": "STRING",
  					"defaultValue": "Packaged TurboWarp project"
  				},
  				"WIDTH": {
  					"type": "STRING",
  					"defaultValue": "480"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "head [CONTENT]",
  			"description": "Creates a head element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "body [CONTENT]",
  			"description": "Creates a body element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "title [CONTENT]",
  			"description": "Creates a title element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Status"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "style [CSS]",
  			"description": "Creates a style element for educational CSS.",
  			"arguments": { "CSS": {
  				"type": "STRING",
  				"defaultValue": ".card { color: red; }"
  			} }
  		},
  		{
  			"opcode": "h1",
  			"blockType": "REPORTER",
  			"text": "h1 [CONTENT]",
  			"description": "Creates an h1 element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "h2 [CONTENT]",
  			"description": "Creates an h2 element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "h3 [CONTENT]",
  			"description": "Creates an h3 element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Heading"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "h4 [CONTENT]",
  			"description": "Creates an h4 element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Heading"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "h5 [CONTENT]",
  			"description": "Creates an h5 element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Heading"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "h6 [CONTENT]",
  			"description": "Creates an h6 element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Heading"
  			} }
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "div [CONTENT]",
  			"description": "Creates a div element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "ul [CONTENT]",
  			"description": "Creates an unordered list element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "ol [CONTENT]",
  			"description": "Creates an ordered list element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "table [CONTENT]",
  			"description": "Creates a table element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "tr [CONTENT]",
  			"description": "Creates a table row element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "th [CONTENT]",
  			"description": "Creates a table header cell element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Name"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "td [CONTENT]",
  			"description": "Creates a table data cell element.",
  			"arguments": { "CONTENT": {
  				"type": "STRING",
  				"defaultValue": "Value"
  			} }
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "input",
  			"description": "Creates a void input element.",
  			"arguments": {}
  		},
  		{
  			"opcode": "textarea",
  ...
  var VALID_NAME = /^[a-zA-Z][a-zA-Z0-9:-]*$/u;
  ...
  var URL_SCHEME_PATTERN = /^[a-z][a-z0-9+.-]*:/iu;
  var PROJECT_ID_PATTERN = /^\d+$/u;
  var FRAME_DIMENSION_PATTERN = /^[1-9]\d{0,4}$/u;
  var TABLE_SECTION_ELEMENTS = /* @__PURE__ */ new Set([
  	"tbody",
  	"thead",
  	"tfoot"
  ]);
  ...
  function withAttribute(fragment, name, value) {
  	if (fragment.kind !== "element") throw new TypeError("Attributes can only be applied to HTML elements.");
  ...
  function renderFragment(fragment) {
  	switch (fragment.kind) {
  		case "empty": return "";
  		case "text": return escapeText(fragment.value);
  		case "sequence": return fragment.children.map(renderFragment).join("");
  		case "element": return renderElement(fragment);
  	}
  }
  function validate(fragment) {
  	const issues = [];
  	const roots = topLevelFragments(fragment);
  	if (roots.length === 0) issues.push({
  		severity: "warning",
  		path: "$",
  		message: "HTML fragment is empty."
  	});
  	else if (roots.length > 1) issues.push({
  		severity: "warning",
  		path: "$",
  		message: "Top-level sequence has multiple roots; wrap a complete document in one html element."
  	});
  	for (const [index, child] of roots.entries()) validateFragment(child, [`$[${index}]`], [], issues);
  	const singleRoot = roots.length === 1 ? roots[0] : void 0;
  	if (singleRoot?.kind === "element" && singleRoot.tagName === "html") validateDocumentElement(singleRoot, issues);
  	return {
  ...
  function turbowarpProjectFrame(projectId, titleText = "TurboWarp project", width = "482", height = "412") {
  	return projectFrame(`https://turbowarp.org/${normalizeProjectId(projectId)}/embed`, titleText, width, height);
  }
  function scratchProjectFrame(projectId, titleText = "Scratch project", width = "485", height = "402") {
  	return projectFrame(`https://scratch.mit.edu/projects/${normalizeProjectId(projectId)}/embed`, titleText, width, height);
  }
  ...
  var html = createElementFactory("html");
  var head = createElementFactory("head");
  var body = createElementFactory("body");
  var title = createElementFactory("title");
  ...
  function normalizeChildren(children) {
  	return (Array.isArray(children) ? children : [children]).filter((child) => child.kind !== "empty");
  }
  ...
  function validateFragment(fragment, path, ancestors, issues) {
  	if (fragment.kind === "sequence") {
  		fragment.children.forEach((child, index) => validateFragment(child, [...path, `children[${index}]`], ancestors, issues));
  		return;
  	}
  	if (fragment.kind !== "element") return;
  	const currentPath = path.join(".");
  	const parent = ancestors[ancestors.length - 1];
  	if (isVoidElement(fragment.tagName) && fragment.children.length > 0) issues.push({
  		severity: "error",
  		path: currentPath,
  	...
  	fragment.children.forEach((child, index) => validateFragment(child, [...path, `children[${index}]`], [...ancestors, fragment], issues));
  }
  function validateElementPlacement(fragment, parent, ancestors, path, issues) {
  	if (fragment.tagName === "head" && parent?.tagName !== "html") issues.push({
  		severity: "warning",
  		path,
  		message: "head should be a direct child of html."
  	});
  	if (fragment.tagName === "body" && parent?.tagName !== "html") issues.push({
  		severity: "warning",
  		path,
  		message: "body should be a direct child of html."
  	});
  	if (fragment.tagName === "title" && parent?.tagName !== "head") issues.push({
  		severity: "warning",
  		path,
  		message: "title should be inside head."
  	});
  	if (fragment.tagName === "style" && parent?.tagName !== "head") issues.push({
  		severity: "warning",
  		path,
  		message: "style should be inside head."
  	});
  	if (fragment.tagName === "li" && parent?.tagName !== "ul" && parent?.tagName !== "ol") issues.push({
  		severity: "error",
  		path,
  		message: "li must be a child of ul or ol."
  	});
  	if (fragment.tagName === "tr" && parent?.tagName !== "table" && !TABLE_SECTION_ELEMENTS.has(parent?.tagName ?? "")) issues.push({
  		severity: "error",
  		path,
  		message: "tr must be a child of table, thead, tbody, or tfoot."
  	});
  	if ((fragment.tagName === "th" || fragment.tagName === "td") && parent?.tagName !== "tr") issues.push({
  		severity: "error",
  		path,
  		message: `${fragment.tagName} must be a child of tr.`
  	});
  	if (fragment.tagName === "option" && parent?.tagName !== "select") issues.push({
  		severity: "error",
  		path,
  		message: "option must be a child of select."
  	});
  	if (fragment.tagName === "form" && ancestors.some((ancestor) => ancestor.tagName === "form")) issues.push({
  		severity: "error",
  		path,
  ...
  function validateRequiredAttributes(fragment, path, issues) {
  	if (fragment.tagName === "img" && !hasAttribute(fragment, "src")) issues.push({
  		severity: "error",
  		path,
  		message: "img requires a src attribute."
  	});
  	if (fragment.tagName === "img" && !hasAttribute(fragment, "alt")) issues.push({
  		severity: "warning",
  		path,
  		message: "img should have an alt attribute."
  	});
  	if (fragment.tagName === "a" && !hasAttribute(fragment, "href")) issues.push({
  		severity: "warning",
  		path,
  		message: "a should have an href attribute."
  	});
  	if (fragment.tagName === "iframe" && !hasAttribute(fragment, "src")) issues.push({
  		severity: "error",
  		path,
  		message: "iframe requires a src attribute."
  	});
  	if (fragment.tagName === "iframe" && !hasAttribute(fragment, "title")) issues.push({
  		severity: "warning",
  		path,
  		message: "iframe should have a title attribute."
  	});
  	if (fragment.tagName === "input" && !hasAttribute(fragment, "type")) issues.push({
  		severity: "warning",
  		path,
  		message: "input should have a type attribute."
  	});
  }
  function validateDocumentElement(fragment, issues) {
  	...
  	if (bodyIndex === -1) issues.push({
  		severity: "warning",
  		path: "$[0]",
  		message: "html should contain a body element."
  	});
  	if (headIndex !== -1 && bodyIndex !== -1 && headIndex > bodyIndex) issues.push({
  		severity: "warning",
  		path: "$[0]",
  		message: "head should appear before body."
  	});
  	if (elementChildren.filter((child) => child.tagName === "head").length > 1) issues.push({
  		severity: "warning",
  		path: "$[0]",
  		message: "html should not contain multiple head elements."
  	});
  	if (elementChildren.filter((child) => child.tagName === "body").length > 1) issues.push({
  		severity: "warning",
  		path: "$[0]",
  		message: "html should not contain multiple body elements."
  	});
  }
  ...
  function renderElement(fragment) {
  	...
  	if (fragment.tagName === "style") return `<style${attributes}>${renderStyleContent(fragment)}</style>`;
  ...
  function renderCssFragment(fragment) {
  	switch (fragment.kind) {
  		case "empty": return "";
  		case "text": return escapeStyleText(fragment.value);
  		case "sequence": return fragment.children.map(renderCssFragment).join("");
  		case "element": return escapeStyleText(renderElement(fragment));
  	}
  }
  ...
  function normalizeTagName(tagName) {
  	...
  	if (!VALID_NAME.test(normalized) || FORBIDDEN_TAGS.has(normalized)) throw new TypeError(`Unsafe or invalid HTML tag name: ${tagName}`);
  	return normalized;
  }
  function normalizeAttributeName(name) {
  	const normalized = name.trim().toLowerCase();
  	if (!VALID_NAME.test(normalized) || normalized.startsWith("on")) throw new TypeError(`Unsafe or invalid HTML attribute name: ${name}`);
  	return normalized;
  }
  ...
  function normalizeProjectId(value) {
  	...
  	if (!PROJECT_ID_PATTERN.test(normalized)) throw new TypeError(`Invalid Scratch project ID: ${value}`);
  	return normalized;
  }
  function validatePackagedProjectSrc(value) {
  	const trimmed = value.trim();
  	if (trimmed.length === 0 || URL_SCHEME_PATTERN.test(trimmed) || trimmed.startsWith("//") || hasControlCharacter(trimmed)) throw new TypeError(`Unsafe packaged project URL: ${value}`);
  }
  ...
  function normalizeFrameDimension(value, name) {
  	const normalized = value.trim();
  	if (!FRAME_DIMENSION_PATTERN.test(normalized)) throw new TypeError(`Invalid iframe ${name}: ${value}`);
  	return normalized;
  }
  ...
  var SERIALIZED_PREFIX = "turbowarp-html:v1:";
  var blockDefinitions = block_definitions_default.blocks;
  var HtmlExtension = class {
  	getInfo() {
  		return {
  	...
  	withAttribute(args) {
  		return encode(withAttribute(decodeRequired(args.ELEMENT), Scratch.Cast.toString(args.NAME), Scratch.Cast.toString(args.VALUE)));
  	}
  	concat(args) {
  	...
  	turbowarpProjectFrame(args) {
  		return encode(turbowarpProjectFrame(Scratch.Cast.toString(args.PROJECT_ID), Scratch.Cast.toString(args.TITLE), Scratch.Cast.toString(args.WIDTH), Scratch.Cast.toString(args.HEIGHT)));
  	}
  	scratchProjectFrame(args) {
  		return encode(scratchProjectFrame(Scratch.Cast.toString(args.PROJECT_ID), Scratch.Cast.toString(args.TITLE), Scratch.Cast.toString(args.WIDTH), Scratch.Cast.toString(args.HEIGHT)));
  	}
  	packagedProjectFrame(args) {
  		return encode(packagedProjectFrame(Scratch.Cast.toString(args.SRC), Scratch.Cast.toString(args.TITLE), Scratch.Cast.toString(args.WIDTH), Scratch.Cast.toString(args.HEIGHT)));
  	}
  	html(args) {
  ...
  function decodeOrText(value) {
  	...
  	return parseFragment(raw.slice(18));
  }
  function decodeRequired(value) {
  	const raw = Scratch.Cast.toString(value);
  	if (!raw.startsWith(SERIALIZED_PREFIX)) throw new TypeError("Expected an HTML element value from this extension.");
  	return parseFragment(raw.slice(18));
  }
  ...
  function isFragment(value) {
  	...
  	if (record.kind === "element") return typeof record.tagName === "string" && typeof record.attributes === "object" && record.attributes !== null && !Array.isArray(record.attributes) && Object.values(record.attributes).every((entry) => typeof entry === "string") && Array.isArray(record.children) && record.children.every(isFragment);
  	return false;
  }
  //#endregion
  //#region src/index.ts
